...
siendo $s^2_a$ la variancia amalgamada de ambos grupos.
...
Se compara a variabilidad entre grupos respecto la variabilidad dentro de los grupos. Ello se resume en la tabla ANOVA:
...
\textit{Notas:}
- En caso de $H_1$ unilateral, los resultados de la prueba \textit{t-student} podrían no coincidir con el enfoque \textit{ANOVA}.
